...
wyswietl_EAX_hex PROC
    ...
    ; rezerwacja 12 bajtów na stosie (poprzez zmniejszenie rejestru ESP) przeznaczonych na tymczasowe przechowanie cyfr szesnastkowych wyœwietlanej liczby
    sub esp, 12
...
wczytaj_do_EAX_oct PROC
    ...
    pocz_konw:
        ...
        sub dl, '0' ; zamiana kodu ASCII na wartoœæ cyfry
        dopisz:
        shl eax, 3 ; przesuniêcie logiczne w lewo o 4 bity
        or al, dl ; dopisanie utworzonego kodu 4-bitowego
        ; na 4 ostatnie bity rejestru EAX
        jmp pocz_konw ; skok na pocz¹tek pêtli konwersji
...
wyswietl_EAX_oct PROC
    ...
    petla:
        mov edx, 0 ; zerowanie starszej czêœci dzielnej
	    div ebx ; dzielenie przez 8, reszta w EDX,
	    ; iloraz w EAX
	    add dl, 30H ; zamiana reszty z dzielenia na kod
	    ; ASCII
        mov znaki [esi], dl; zapisanie cyfry w kodzie ASCII
